...
class FacebookService {
    ...
    async handleDownload(e) {
        ...
        if (!url) {
            Utils.showError(this.downloadError, 'Please enter a valid Facebook video URL');
            return;
        }

        if (!url.includes('facebook.com')) {
            Utils.showError(this.downloadError, 'Please enter a valid Facebook URL');
            return;
        }
        ...
        try {
            ...
            if (data.success) {
                ...
                Utils.showError(this.downloadError, data.message || 'Failed to download Facebook video');
            }
        } catch (error) {
